...
public class LogAspect {
	...
	// * le join point
	// */
	// @Before("execution(* com.banque.service.AbstractService+.*(..))")
	// public void logBefore(JoinPoint jp) {
	// if (LogAspect.LOG.isInfoEnabled()) {
	// LogAspect.LOG.info("Passage avant " + jp.getTarget() + " " +
	// jp.getSignature());
	// }
	// }
	//
	...
	// * le join point
	// */
	// @After("execution(* com.banque.service.AbstractService+.*(..))")
	// public void logAfter(JoinPoint jp) {
	// if (LogAspect.LOG.isInfoEnabled()) {
	// LogAspect.LOG.info("Passage apres " + jp.getTarget() + " " +
	// jp.getSignature());
	// }
	// }
