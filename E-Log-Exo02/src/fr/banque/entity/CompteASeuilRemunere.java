...
public class CompteASeuilRemunere extends CompteRemunere implements ICompteASeuil {
	...
	private final static Logger LOG = LogManager.getLogger(CompteASeuilRemunere.class);
	...
	public void retirer(double unMontant) throws BanqueException {
		...
		if (simu <= this.getSeuil()) {
			CompteASeuilRemunere.LOG.debug("Votre seuil de {} ne vous permet pas de retirer {} de votre compte {}",
