...
public class Client implements Serializable {
	...
	public ListeCompte getComptes() {
		...
		return liste;
		// return this.tabComptes.values().toArray(new
		// Compte[this.tabComptes.size()]);
	}

	public void setComptes(ListeCompte liste) {
		this.tabComptes = new HashMap<Integer, Compte>();
		for (Compte compte : liste.getListeCompte()) {
			this.tabComptes.put(compte.getNumero(), compte);
		}
	}
